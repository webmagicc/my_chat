...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // color of lSource Sans Pro showing current value
    ...
    // lSource Sans Pro : string
    // text to show below value
    lSource Sans Pro: kvLookup('lSource Sans Pro', config, dataset, ''),

    // lSource Sans ProFontColor : string
    // color of lSource Sans Pro showing lSource Sans Pro under value
    lSource Sans ProFontColor: kvLookup('lSource Sans ProFontColor', config, dataset, "#b3b3b3"),
    ...
    // lSource Sans ProMinFontSize
    // absolute minimum font size for the lSource Sans Pro
    lSource Sans ProMinFontSize: kvLookup('lSource Sans ProMinFontSize', config, dataset, 10),

    // minLSource Sans ProMinFontSize
    // absolute minimum font size for the minimum lSource Sans Pro
    minLSource Sans ProMinFontSize: kvLookup('minLSource Sans ProMinFontSize', config, dataset, 10),

    // maxLSource Sans ProMinFontSize
    // absolute minimum font size for the maximum lSource Sans Pro
    maxLSource Sans ProMinFontSize: kvLookup('maxLSource Sans ProMinFontSize', config, dataset, 10),
  ...
  if (obj.config.donut === true) {
    ...
    valueX = dx + widgetW / 2;
    if (obj.config.lSource Sans Pro !== '') {
    ...
    // lSource Sans Pro
    lSource Sans ProFontSize = ((widgetH / 16) > 10) ? (widgetH / 16) : 10;
    lSource Sans ProX = dx + widgetW / 2;
    lSource Sans ProY = valueY + lSource Sans ProFontSize;

    // min
    minFontSize = ((widgetH / 16) > 10) ? (widgetH / 16) : 10;
    minX = dx + (widgetW / 10) + (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) / 2;
    minY = lSource Sans ProY;

    // max
    maxFontSize = ((widgetH / 16) > 10) ? (widgetH / 16) : 10;
    maxX = dx + widgetW - (widgetW / 10) - (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) / 2;
    maxY = lSource Sans ProY;
    ...
    // lSource Sans Pro
    lSource Sans ProFontSize = ((widgetH / 16) > obj.config.lSource Sans ProMinFontSize) ? (widgetH / 16) : obj.config.lSource Sans ProMinFontSize;
    lSource Sans ProX = dx + widgetW / 2;
    lSource Sans ProY = valueY + valueFontSize / 2 + 5;

    // min
    minFontSize = ((widgetH / 16) > obj.config.minLSource Sans ProMinFontSize) ? (widgetH / 16) : obj.config.minLSource Sans ProMinFontSize;
    minX = dx + (widgetW / 10) + (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) / 2;
    minY = lSource Sans ProY;

    // max
    maxFontSize = ((widgetH / 16) > obj.config.maxLSource Sans ProMinFontSize) ? (widgetH / 16) : obj.config.maxLSource Sans ProMinFontSize;
    maxX = dx + widgetW - (widgetW / 10) - (widgetW / 6.666666666666667 * obj.config.gaugeWidthScale) / 2;
    maxY = lSource Sans ProY;
  }
  ...
  obj.params = {
    ...
    valueX: valueX,
    valueY: valueY,
    lSource Sans ProFontSize: lSource Sans ProFontSize,
    lSource Sans ProX: lSource Sans ProX,
    lSource Sans ProY: lSource Sans ProY,
  ...
  // var clear
  canvasW, canvasH, widgetW, widgetH, aspect, dx, dy, titleFontSize, titleX, titleY, valueFontSize, valueX, valueY, lSource Sans ProFontSize, lSource Sans ProX, lSource Sans ProY, minFontSize, minX, minY, maxFontSize, maxX, maxY = null;
  ...
  // lSource Sans Pro
  obj.txtLSource Sans Pro = obj.canvas.text(obj.params.lSource Sans ProX, obj.params.lSource Sans ProY, obj.config.lSource Sans Pro);
  obj.txtLSource Sans Pro.attr({
    "font-size": obj.params.lSource Sans ProFontSize,
    "font-weight": "normal",
    "font-family": "Arial",
    "fill": obj.config.lSource Sans ProFontColor,
    "fill-opacity": "0"
  });
  setDy(obj.txtLSource Sans Pro, obj.params.lSource Sans ProFontSize, obj.params.lSource Sans ProY);
  ...
  // animate gauge level, value & lSource Sans Pro
  ...
  obj.txtLSource Sans Pro.animate({
    "fill-opacity": "1"
  }, obj.config.startAnimationTime, obj.config.startAnimationType);
};
